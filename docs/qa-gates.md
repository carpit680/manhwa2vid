...
| `story-coverage` | warn | longest run of consecutive story panels the video never shows ≤ 24 | **new 2026-09-02.** `panel-utilisation` measures a SHARE, which is the wrong question at length: a 20-chapter range has ~1640 story panels and the word budget buys ~640 shots, so 39% is arithmetic. The user's standard is "lesser panels are fine as long as the story is conveyed without disconnect", and a disconnect is a HOLE. Measured: the two shipped short videos have longest gaps of 8 and 10 panels; the first 20-chapter probe had a healthy median gap of 2 and one run of **165 panels — 27 pages no paragraph covered at all**, because the writer skipped the sequence. 24 sits well clear of sampling and well under a skipped scene |
| `panel-utilisation` | warn | ≥ 35% of story panels reach the screen | brief |
